...
const MessageFormatter = ({
  ...
  return (
    <div
      className={`flex flex-col gap-2.5 w-full text-[14.5px] ${role === "user" ? "items-end" : "items-start"} ${notoSansKr.className}`}
    >
      <link
        rel="stylesheet"
                ...
                recommend.map((problem: any) => (
                  ...
                  >
                    <div className="flex items-center justify-between w-full">
                      ...
                      <span
                        className={`text-[9px] font-bold px-1.5 py-0.5 rounded border ${getDifficultyColor(problem.difficulty)}`}
                      >
                        {problem.difficulty}
                      </span>
                    </div>
