...
export default function CodeDiagnosisForm() {
  ...
  return (
    <div className={`min-h-screen py-10 px-4 antialiased text-gray-800 ${notoSansKr.className}`}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            질의에 관련한 코드와 상세 정보를 입력하면 정확한 분석 및 향후 학습 지도를 도와드립니다.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-[#FAFAFA] border border-gray-200 rounded-xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <span className="bg-[#EEF2FF] text-[#4F46E5] text-sm font-bold px-2 py-0.5 rounded">01</span>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-[13px] font-bold text-gray-700 mb-2">심각도</label>
              ...
              <div>
                <label className="block text-[13px] font-bold text-gray-700 mb-2">실행 환경</label>
                <input
                  type="text"
                  name="environment"
          ...
          <div className="bg-[#FAFAFA] border border-gray-200 rounded-xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <span className="bg-[#EEF2FF] text-[#4F46E5] text-sm font-bold px-2 py-0.5 rounded">02</span>
          ...
          {formData.isSolved === 'unsolved' && (
            <div className="bg-[#FAFAFA] border border-red-200/60 rounded-xl p-8 animate-fadeIn">
              <div className="flex items-center gap-3 mb-6">
                <span className="bg-red-50 text-red-600 text-sm font-bold px-2 py-0.5 rounded">03</span>
                <h2 className="text-[17px] font-bold text-gray-900">오류 정보</h2>
              </div>

              <div className="space-y-6">
                
                <div>
                  <label className="block text-[13px] font-bold text-gray-700 mb-2">오류 유형</label>
                  <select
                    name="errorType"
                  ...
                  >
                    ...
                    <option value="performance">Performance Issue (성능 문제)</option>
                  </select>
                </div>
